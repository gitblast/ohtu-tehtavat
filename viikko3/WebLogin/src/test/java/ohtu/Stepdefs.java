...
public class Stepdefs {
    ...
    public void aValidUsernameAndPasswordAndMatchingPasswordConfirmationAreEntered(String user, String pass) {
    ...
    public void anInvalidUsernameAndPasswordAndMatchingPasswordConfirmationAreEntered(String user, String pass) {
        createUser(user, pass, pass);
    }

    @When("a valid username {string} and too short password {string} and matching password confirmation are entered")
    public void aValidUsernameAndTooShortPasswordAndMatchingPasswordConfirmationAreEntered(String user, String pass) {
        createUser(user, pass, pass);
    }

    @When("a valid username {string} and password {string} and non-matching password confirmation are entered")
    public void aValidUsernameAndPasswordAndNonMatchingPasswordConfirmationAreEntered(String user, String pass) {
        createUser(user, pass, "different");
    }
    ...
    public void usernameAndPasswordAreEntered(String string, String string2) {
    ...
    @When("nonexisting username {string} and valid password {string} are given")
    public void nonexistingUsernameIsGiven(String username, String password) {
        logInWith(username, password);
    }
